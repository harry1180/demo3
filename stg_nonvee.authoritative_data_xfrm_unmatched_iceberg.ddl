CREATE TABLE stg_nonvee.authoritative_data_xfrm_${opco}_unmatched (
    serialnumber STRING,
    source STRING,
...
LOCATION '${HDFS_DATA_WORK}/util/intervals/authoritative/authoritative_data_xfrm_${opco}_unmatched'
TBLPROPERTIES (
  --'write.format.default' = 'orc',
  'orc.bloom.filter.columns' = 'serialnumber, endtimeperiod',
